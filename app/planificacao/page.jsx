        ...
        <>
          {planificacaoTT ? (
            <>
              ...
              <Spacer y={1} />
              <div className="text-center font-bold underline underline-offset-8 uppercase">
                Road Map
              </div>
              <Button
                    ...
                    {cronograma.length > 0 &&
                      ...
                      <Col css={{ d: "flex" }}>
                        ...
                        >
                          ...
                          <Text>Data: {crono.data}</Text>
                          <Text>{crono.corpo}</Text>
                        </Collapse>
                      ))}
                  </Collapse.Group>
                  {/* Road Map inicio */}
                  ...
                  <div id="progress-content-section">
                    <div className="section-content map1 active">
                      ...
                      <p>
                        ...
                        Voluptates quidem, nemo reiciendis voluptas placeat
                        mollitia dolores unde eos ea? Quia nam vitae esse labore
                        at ratione repudiandae porro facilis inventore.
                      </p>
                    </div>
