  ...
  return (
    <div className="flex-between w-full mb-16 pt-3">
      ...
      <nav class="menu">
          <ol>
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 cursor-pointer'>Planificação</h2>
              <ol class="sub-menu">
            ...
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Serviços</h2>
              <ol class="sub-menu">
            ...
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Convidados</h2>
              <ol class="sub-menu">
            ...
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Convites</h2>
              <ol class="sub-menu">
            ...
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Streaming</h2>
            </li>
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Cronograma</h2>
            </li>
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Facturação</h2>
            </li>
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Inspiração</h2>
              <ol class="sub-menu">
            ...
            <li class="menu-item">
              <h2 href="#0" className='text-white text-sm my-1 mx-1 cursor-pointer'>Dicas</h2>
              <ol class="sub-menu">
